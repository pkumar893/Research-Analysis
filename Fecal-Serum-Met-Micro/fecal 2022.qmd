...
```{r echo=FALSE}
# setwd("E:/Ajit data analysis/Tac") 
...
#top_var_metabolites <- visualize_correlation_heatmap(cor_matrix, 25)
# ggsave("E:/Ajit data analysis/Tac/fecal set1/correlation_heatmap.png", 
#        plot = top_var_metabolites, 
#        width = 20, height = 15, 
#        units = "in", 
#        dpi = 600,  
#        bg = "white") 

# png("E:/Ajit data analysis/Tac/fecal set1/top_metabolite_corrplot.png", 
#     width = 20, height = 15, 
#     units = "in", res = 300)
...
top_var_metabolites <- visualize_correlation_heatmap(cor_matrix, 30, 
                                                     save_path = 
                                                       "E:/Ajit data analysis/Tac/fecal set1/correlation_heatmap.pdf")
visualize_correlation_heatmap(cor_matrix, 30)
```
...
# metabolites with most different means between groups
...
# Plot top different metabolites
...
```{r include=FALSE}
# # Save results
# write.csv(strong_cors, "strong_correlations.csv", row.names = FALSE)
# write.csv(diff_cors, "differential_correlations_Sham_vs_TAC.csv", row.names = FALSE)
# write.csv(anova_results, "metabolite_association_with_groups.csv", row.names = FALSE)
# write.csv(cluster_analysis, "metabolite_clusters.csv", row.names = FALSE)
# write.csv(diff_means, "fold_changes_vs_Sham.csv", row.names = FALSE)
# write.csv(covariation_results$covarying_pairs, "covarying_metabolites.csv", row.names = FALSE)
# 
# # Save plots
# ggsave("correlation_heatmap.png", width = 10, height = 8)
# ggsave("differential_correlations.png", plot_differential_correlation(diff_cors, c("Sham", "TAC")), width = 10, height = 8)
# ggsave("group_differences.png", plot_group_differences(data, anova_results, 6), width = 12, height = 8)
# ggsave("correlation_network.png", all_network, width = 12, height = 10)
# ggsave("mean_differences.png", plot_mean_differences(data, diff_means, 9), width = 12, height = 8)
# ggsave("covarying_metabolites.png", plot_covarying_metabolites(data, covariation_results$covarying_pairs, 4), width = 12, height = 10)
```
...
## New Analysis to understan overall effet of the metabolite on heart mass
```{r}
Fecal1 <- read_excel("E:/Ajit data analysis/Tac/Fecal metablomics 2022 set 1.xlsx")
...
```{r}
# write.csv(cor_matrix, "E:/Ajit data analysis/Tac/cor_matrix2.csv")
```
...
p
 ...
 # ggsave("E:/Ajit data analysis/Tac/fecal 2022/Overall Effect of Metabolites on Heart Weight nfold 10.png",
 #        p,
 #        width = 9, height = 6.5,
 #        dpi = 400)
 # 
...
p2
 ...
 # ggsave("E:/Ajit data analysis/Tac/fecal 2022/Overall Effect of Metabolites on Heart Weight 2022 nfold 5.png",
 #        p2,
 #        width = 16, height = 10,
 #        dpi = 400)
...
# ( + theme(
#     panel.background = element_blank(),      # Remove grey panel
